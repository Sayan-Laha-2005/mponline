...
namespace EmployeeCustomSorting
{
    ...
    class Program
    {
        static void Main()
        {
            ...
            {
                new Employee(105, "Zoya",  55000m, new DateTime(2021, 7,  1)),
                new Employee(102, "Rabi",   72000m, new DateTime(2019, 3, 15)),
                new Employee(108, "Priyam",  45000m, new DateTime(2023, 1, 10)),
